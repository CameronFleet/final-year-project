...
TAKEN FROM gym.rendering framework
"""
...
class Viewer(object):
    ...
    def add_textlist(self, obj):
        self.text_list.append(obj)
    ...
    def render(self, return_rgb_array=False):
        ...
        curr_time = time.time()
        if curr_time - self.poll_time >= 0.5:
            self.fps = self.frame_counter * 2
            self.poll_time = curr_time
            self.frame_counter = 0
